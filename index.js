...
Jumper.Play.prototype = {
  ...
  preload: function() {
    ...
    this.load.image( 'hero2', 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/836/dude.png' );
  },
  ...
  update: function() {
    ...
    this.cameraYMin = Math.min( this.cameraYMin, this.hero2.y - this.game.height + 130 );
    this.camera.y = this.cameraYMin;

    // hero collisions and movement
    this.physics.arcade.collide( this.hero, this.platforms );
    this.physics.arcade.collide( this.hero2, this.platforms );
    this.heroMove();
  ...
  heroCreate: function() {
    ...
    hero2Create: function() {
    // basic hero setup
    this.hero2 = game.add.sprite( this.world.centerX-100, this.world.height - 36, 'hero2' );
    this.hero2.anchor.set( 0.5 );
    ...
    // hero collision setup
    // disable all collisions except for down
    this.physics.arcade.enable( this.hero2 );
    this.hero2.body.gravity.y = 500;
    this.hero2.body.checkCollision.up = false;
    this.hero2.body.checkCollision.left = false;
    this.hero2.body.checkCollision.right = false;
  },
    ...
    if( this.cursor.left2.isDown ) {
      this.hero2.body.velocity.x = -200;
    } else if( this.cursor.right2.isDown ) {
      this.hero2.body.velocity.x = 200;
    } else {
      this.hero2.body.velocity.x = 0;
    }
    ...
    if( this.cursor.up2.isDown && this.hero2.body.touching.down ) {
      this.hero2.body.velocity.y = -350;
    }  
    ...
    else if( this.hero2.y > this.cameraYMin + this.game.height && this.hero2.alive ) {
    this.state.start( 'Play' );
      alert("Player1 Win");
    }
